...
col1 = st.sidebar # column 1 is set to sidebar
col2, col3 = st.columns((2,1)) # specifying that the width of the 2nd column is twise as that of the 3rd column
# column 2 is the dataframes and column 3 is the plots 
...
# Web Scraping of CoinMerkertCap data
@st.cache
def load_data():
    ...
    st.text_area(f"coin_data: {coin_data}")
